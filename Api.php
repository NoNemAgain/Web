...
//Api avec les informations des  écoles 
...
//Si les API ne sont pas fonctionnelles
if ($arrayComplet==null||$arrayMap==null){
 echo'<script>';
    echo"alert('API ne marche pas' );";
     echo'  </script>';
}

//Instanciation des facets 
else{
